...
## all word combinations including those of count one included
## 5 percent of source file sampled

bigram_data <- readRDS("./bigram_data5.rds")
trigram_data <- readRDS("./trigram_data5.rds")
quadgram_data <- readRDS("./quadgram_data5.rds")
...
## 
testing_data <- readRDS("./testingdata1.rds")
testing_data_nolastword <- readRDS("./testingdatanolastword1.rds")

testresults <- sapply(testing_data_nolastword[1000:2000], next_word_predictor)
testresults <- paste0(testing_data_nolastword[1000:2000], " ", testresults)
sum(testresults==testing_data[1000:2000])/1001
